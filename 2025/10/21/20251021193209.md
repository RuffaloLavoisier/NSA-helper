# Commit: c391d497bc67a2baf1def18ff9e8dd97a0262b38
## Message: Merge remote-tracking branch 'origin/GP-5929_dev747368_markup_gnubuildattributes'
## Diff:
```
diff --git a/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/ElfNote.java b/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/ElfNote.java
index 58e1848ae4b..989fb5d00c4 100644
--- a/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/ElfNote.java
+++ b/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/ElfNote.java
@@ -4,9 +4,9 @@
...
diff --git a/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/GnuBuildAttribute.java b/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/GnuBuildAttribute.java
new file mode 100644
index 00000000000..1757a64af2a
--- /dev/null
+++ b/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/GnuBuildAttribute.java
@@ -0,0 +1,438 @@
+/* ###
+ * IP: GHIDRA
+ *
...
+	}
+}
diff --git a/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/GnuBuildAttributes.java b/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/GnuBuildAttributes.java
new file mode 100644
index 00000000000..c9df0b0efda
--- /dev/null
+++ b/Ghidra/Features/Base/src/main/java/ghidra/app/util/bin/format/elf/info/GnuBuildAttributes.java
@@ -0,0 +1,122 @@
+/* ###
+ * IP: GHIDRA
+ *
...
index aa0574777f8..2689e7a7eff 100644
