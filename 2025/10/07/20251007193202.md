# Commit: 85f07ad803896b06fca170042216677a0ea308a9
## Message: GP-6016 - Updated the Function Comparison provider to save Listing format changes; fixed last used tab not being saved.
## Diff:
```
...
index bef7de2281a..6f6dcdf516d 100644
...
@@ -229,9 +234,8 @@ public void stateChanged(ChangeEvent e) {
...
+		JComponent component = tabComponentsByName.get(name);
 		if (component != null) {
 			if (tabbedPane.getSelectedComponent() == component) {
 				tabChanged();
@@ -246,7 +250,7 @@ public boolean setCurrentTabbedComponent(String name) {
 	 *
...
@@ -254,14 +258,6 @@ public String getCurrentComponentName() {
 		return null;
 	}
...
-
 	 ...
 	 */
@@ -280,7 +276,7 @@ public void programClosed(Program program) {
 		}
 	}
...
+	public CodeComparisonView getView(String name) {
 		for (CodeComparisonView view : codeComparisonViews) {
 			if (name.equals(view.getName())) {
 				return view;
@@ -289,21 +285,12 @@ public CodeComparisonView getCodeComparisonView(String name) {
 		return null;
 	}
...
@@ -311,7 +298,7 @@ private void createMainPanel() {
...
@@ -348,32 +335,34 @@ private void readViewState() {
...
@@ -381,7 +370,7 @@ private void writeOrientationState() {
...
index 2f24f2ac6e4..4292ba70b08 100644
...
@@ -160,7 +160,7 @@ private JComponent createComponent() {
 		functionComparisonPanel = fcService.createComparisonViewer();
