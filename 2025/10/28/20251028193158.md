# Commit: 4353b04294d1dbe0bd203e22a619bd44ea0b05a6
## Message: GP-1915 - Data Type Manager - Added an action to search for enums by value
## Diff:
```
...
index 3f5bb0c0644..9528dd8e679 100644
...
@@ -189,12 +189,13 @@ private void createLocalActions() {
 		// VeryLast group
...
index a9972ba0eef..0d2e289fe65 100644
...
+import ghidra.program.model.data.Enum;
 ...
 import util.CollectionUtils;
@@ -770,6 +771,26 @@ public void testEditorActionsGetRegisteredWithoutEditing() {
...
@@ -824,7 +845,7 @@ public void testAction_FindStructureByOffset_MixedInput() {
...
+		createStructureWithOffset_0x20(); // 0x8, 0x10, 0x18, 0x32
 		...
 		performAction(action, false);
@@ -845,8 +866,8 @@ public void testAction_FindStructureBySize() {
...
+		createStructureWithOffset_0x20(); // 40
 		...
 		performAction(action, false);
@@ -885,14 +906,14 @@ public void testAction_FindStructureBySize_Ranage() {
...
@@ -1183,6 +1204,32 @@ private void selectDataTypes(DataType dt1, DataType dt2) {
 		waitForTree(tree);
 	}
...
@@ -1203,10 +1250,9 @@ private void createStructureWithOffset_0x8() {
...
@@ -1215,8 +1261,9 @@ private void createStructureWithOffset_0x20() {
...
@@ -1343,6 +1390,21 @@ private void assertSingleFilterMatch(String[] path) {
 		}
 	}
...
+
 	private void assertMatchingStructures(DataTypesProvider resultsProvider, String... names) {
 		...
 		DataTypeArchiveGTree gTree = resultsProvider.getGTree();
@@ -1358,6 +1420,26 @@ private void assertMatchingStructures(DataTypesProvider resultsProvider, String.
 		}
 	}
