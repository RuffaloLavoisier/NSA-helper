# Commit: 50fbc20f3f53136e059dc5abe6fbc421c4eb7b8d
## Message: Updated ImporterDialog to remember the last used folder
## Diff:
```
...
index 3760ebf4837..426c1e929df 100644
...
@@ -367,6 +370,15 @@ protected void okCallback() {
 		//@formatter:on
...
@@ -586,15 +598,26 @@ private LanguageCompilerSpecPair getPreferredLanguage(Loader loader) {
...
@@ -603,9 +626,10 @@ private void chooseProjectFolder() {
 		}
 	}
