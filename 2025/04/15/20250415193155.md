# Commit: 277656074353e43a734c336eb502191caa3c3546
## Message: GP-5578 fixed sizing issues with with program tabs, including handling case when java scaling factor is not 1
## Diff:
```
