# Commit: 0ef28cb54bcd68be393a4214270a5dbd73403192
## Message: GP-5557 Composite editor transaction and update notification fixes
## Diff:
```
...
index 832d6e0e502..6f510b2e29d 100644
...
index 66db8ab1c5e..8cdfa64106a 100644
...
index ff8edd751ea..9dbd2278712 100644
...
@@ -990,7 +979,6 @@ public boolean moveUp() throws NoSuchElementException {
...
@@ -1014,7 +1002,6 @@ public boolean moveDown() throws NoSuchElementException {
 		int newIndex = startIndex + 1;
...
-			componentEdited();
 			...
 			tmpFieldSelection.addRange(newIndex, newIndex + numSelected);
 			setSelection(tmpFieldSelection);
@@ -1034,7 +1021,6 @@ public void duplicateMultiple(int rowIndex, int multiple, TaskMonitor monitor)
...
@@ -1138,9 +1124,7 @@ public int getRowCount() {
...
@@ -1279,7 +1263,7 @@ public void restored(DataTypeManager dataTypeManager) {
 			return;
 		}
...
+		T composite = getOriginalComposite();
 		...
 		if (hasChanges || !viewComposite.isEquivalent(composite)) {
 			hasChanges = true;
@@ -1318,7 +1302,11 @@ public void restored(DataTypeManager dataTypeManager) {
...
@@ -1375,7 +1363,7 @@ public void dataTypeRemoved(DataTypeManager dtm, DataTypePath path) {
...
+			throw new AssertException("Listener only supports original DTM");
 		...
 		if (!isLoaded()) {
@@ -1429,7 +1417,11 @@ public void dataTypeRenamed(DataTypeManager dtm, DataTypePath oldPath, DataTypeP
...
@@ -1463,20 +1455,14 @@ public void dataTypeMoved(DataTypeManager dtm, DataTypePath oldPath, DataTypePat
...
-
 			...
 			// structure.
@@ -1561,7 +1547,7 @@ public void dataTypeReplaced(DataTypeManager dtm, DataTypePath oldPath, DataType
...
+			throw new AssertException("Listener only supports original DTM");
 		...
 		if (!isLoaded()) {
@@ -1727,15 +1713,6 @@ public int getLastNumDuplicates() {
...
index 942bc35cf40..33e033a3460 100644
...
index 435ef41b7ce..8c720ef3bec 100644
...
index deb7e365607..d9cdb769531 100644
...
index ab9f52d06a4..02076bfb801 100644
...
@@ -184,14 +184,13 @@ public DataTypeComponent getComponent(int rowIndex) {
...
@@ -215,8 +214,7 @@ void setStructureSize(int size) {
 		}
...
@@ -278,7 +276,7 @@ public void clearComponents(int[] indices) {
 				}
...
@@ -291,7 +289,6 @@ public void clearComponents(int[] indices) {
 				}
 			}
 		});
-		componentEdited();
...
-			componentEdited();
 			...
 			tmpFieldSelection.addRange(newIndex, newIndex + numSelected);
 			setSelection(tmpFieldSelection);
@@ -865,7 +859,7 @@ protected DataTypeComponent insert(int rowIndex, DataType dataType, int length,
 				}
 				else {
...
@@ -927,7 +921,7 @@ protected DataTypeComponent replace(int rowIndex, DataType dataType, int length,
...
@@ -948,16 +942,15 @@ else if (diffLen > 0) {
 			}
 			else {
 				dtc = viewDTM.withTransaction("Replace Component", () -> {
...
@@ -1052,9 +1045,8 @@ else if (remainingLength < 0) {
...
@@ -1329,8 +1321,6 @@ public void unpackage(int rowIndex, TaskMonitor monitor) throws UsrException {
 		}
...
@@ -1373,13 +1363,13 @@ else if (currentDataType instanceof Structure) {
 						if (!isPackingEnabled()) {
...
@@ -1406,7 +1396,6 @@ else if (currentDataType instanceof Structure) {
...
index 63f1e254336..d9b745d4f11 100644
...
index 70df062d1c4..a1dec728d13 100644
...
index 71607a065e5..6f8f4ae1f23 100644
...
+		return viewComposite;
 	...
 	@Override
@@ -461,8 +454,7 @@ private OffsetPairs getRelOffsetSelection() {
...
@@ -475,8 +467,8 @@ private OffsetPairs getRelOffsetSelection() {
...
@@ -485,8 +477,8 @@ private void setRelOffsetSelection(OffsetPairs offsets) {
...
@@ -499,7 +491,7 @@ private void setRelOffsetSelection(OffsetPairs offsets) {
 				}
 			}
 			else {
...
@@ -547,7 +539,7 @@ void setLocalSize(int size) throws UsrException {
...
@@ -559,28 +551,28 @@ void setParameterSize(int size) throws UsrException {
 			throw new UsrException(
...
+		return viewComposite.getReturnAddressOffset();
 	...
 	@Override
@@ -591,7 +583,7 @@ public int getMaxAddLength(int index) {
 	@Override
...
+		return viewComposite.getMaxLength(offset);
 	...
 	@Override
@@ -653,7 +645,7 @@ public boolean isAddAllowed(int currentIndex, DataType dataType) {
 //				return false;
 //			}
 //		}
...
@@ -674,7 +666,7 @@ public boolean isArrayAllowed() {
...
+		return viewComposite.getDefinedComponentAtOrdinal(index) != null;
 	...
 	@Override
@@ -730,7 +722,7 @@ public boolean isReplaceAllowed(int currentIndex, DataType dataType) {
 			return false;
 		}
...
@@ -738,8 +730,7 @@ public boolean isReplaceAllowed(int currentIndex, DataType dataType) {
 	}
...
@@ -749,7 +740,8 @@ private void adjustComponents(DataType dataType) {
...
@@ -765,8 +757,7 @@ private void adjustComponents(DataType dataType) {
 	}
...
+		DataTypeComponent[] comps = viewComposite.getDefinedComponents();
 		...
 		for (DataTypeComponent component : comps) {
 			DataType compDt = component.getDataType();
@@ -776,7 +767,7 @@ private void replaceComponents(DataType oldDataType, DataType newDataType) {
 					len = component.getLength();
 				}
 				try {
...
@@ -795,7 +786,7 @@ private void replaceComponents(DataType oldDataType, DataType newDataType) {
...
+		viewComposite.setDataType(index, dt, length);
 	...
 	@Override
@@ -815,7 +806,7 @@ public boolean setComponentName(int rowIndex, String newName) throws InvalidName
...
@@ -841,7 +832,7 @@ private boolean isOriginalFieldName(String testName, int rowIndex) {
...
+		if (viewComposite.setComment(currentIndex, comment)) {
 			...
 			componentDataChanged();
@@ -973,7 +964,7 @@ public boolean apply() throws EmptyCompositeException, InvalidDataTypeException
...
@@ -1017,7 +1008,7 @@ public boolean apply() throws EmptyCompositeException, InvalidDataTypeException
...
@@ -1135,8 +1126,7 @@ public int getMaxElements() {
...
+		DataTypeComponent dtc = viewComposite.getDefinedComponentAtOrdinal(index);
 		if (dtc == null) {
 			setStatus("Can only create arrays on a defined stack variable.", true);
 			return 0;
@@ -1179,12 +1169,7 @@ public void restored(DataTypeManager dataTypeManager) {
 			}
 		}
 		if (reload) {
-
...
+			load(function);
 			...
 			refresh();
@@ -1193,19 +1178,26 @@ public void restored(DataTypeManager dataTypeManager) {
...
@@ -1219,61 +1211,63 @@ public void dataTypeMoved(DataTypeManager dataTypeManager, DataTypePath oldPath,
...
+		return originalComposite;
 	...
 	@Override
@@ -1305,8 +1299,7 @@ protected void refresh() {
 	}
...
+		DataTypeComponent[] comps = viewComposite.getDefinedComponents();
 		for (int i = comps.length - 1; i >= 0; i--) {
 			...
 			DataType compDt = component.getDataType();
@@ -1326,7 +1319,7 @@ private void refreshComponents() {
 	@Override
...
index 3687e1d4105..8ddf7e2fc17 100644
...
@@ -57,7 +55,7 @@ public void testUnalignedStructure() {
...
@@ -76,7 +74,7 @@ public void testDefaultAlignedStructure() throws Exception {
...
+		addFlexDataType(structureModel.viewComposite, DWordDataType.dataType, null,
 		...
 		waitForSwing();
@@ -110,7 +108,7 @@ public void testMachineAlignedStructure() throws Exception {
...
+		addFlexDataType(structureModel.viewComposite, DWordDataType.dataType, null,
 		...
 		waitForSwing();
@@ -138,11 +136,11 @@ public void testMachineAlignedStructure() throws Exception {
 	public void testByValueAlignedStructure() throws Exception {
 		init(emptyStructure, pgmRootCat, false);
...
+		addFlexDataType(structureModel.viewComposite, DWordDataType.dataType, null,
 		...
 		waitForSwing();
@@ -209,7 +207,7 @@ public void checkByValueAlignedStructure(int value, int alignment, int length, i
...
+		StructureEditorPanel editorPanel = (StructureEditorPanel) getPanel();
 		...
 		JRadioButton explicitAlignButton =
 			(JRadioButton) getInstanceField("explicitAlignButton", editorPanel);
@@ -243,11 +241,11 @@ public void testDefaultAlignedPacked1Structure() throws Exception {
...
index d3604b207b6..3798e13522d 100644
...
index 72c2e8ed2df..fabda97fda4 100644
...
+ *
  ...
  * distributed under the License is distributed on an "AS IS" BASIS,
  * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
@@ -500,11 +500,21 @@ public default <E extends Exception, T> T withTransaction(String description,
...
@@ -546,12 +556,12 @@ public default <E extends Exception, T> T withTransaction(String description,
...
index 395ece69da4..07268f19b1d 100644
...
@@ -380,11 +381,27 @@ public DataType replaceDataType(DataType existingDt, DataType replacementDt,
