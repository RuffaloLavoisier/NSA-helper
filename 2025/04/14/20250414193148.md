# Commit: 3725eb0b39cafa774896b265b080e15ff15f4b19
## Message: Merge branch 'GP-5557_ghidra1_CompositeEditorFixes' into patch
## Diff:
```
...
index 417010fcc91..d7a69ecd28f 100644
...
index df8bf09d898..f3d316033a0 100644
...
@@ -1302,8 +1294,6 @@ public void unpackage(int rowIndex, TaskMonitor monitor) throws UsrException {
 		}
...
@@ -1346,13 +1336,13 @@ else if (currentDataType instanceof Structure) {
 						if (!isPackingEnabled()) {
...
@@ -1379,7 +1369,6 @@ else if (currentDataType instanceof Structure) {
