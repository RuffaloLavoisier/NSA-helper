# Commit: 0878da155c4f60e6bff0d11579fa56064bd5b197
## Message: Merge remote-tracking branch 'origin/GP-5301_Dan_testEmuThumbPlt'
## Diff:
```
...
index 370a13aeb37..aa4080681e9 100644
...
+import ghidra.program.model.lang.*;
 ...
 /**
@@ -615,16 +615,17 @@ public void generateStoreCode(JitCodeGenerator gen, JitType type, MethodVisitor
 	 * <p>
...
+			return new VarDesc(vn.getSpace(), vn.getOffset(), vn.getSize(), type, language);
 		...
 		/**
@@ -633,20 +634,232 @@ static VarDesc fromVarnode(Varnode vn, JitType type) {
 		 * @return the name
 		 */
 		public String name() {
...
@@ -654,7 +867,7 @@ public Varnode toVarnode(AddressFactory factory) {
...
@@ -695,7 +908,7 @@ private JvmLocal genFreeLocal(String name, SimpleJitType type, VarDesc desc) {
 		else {
 			nextLocal += 1;
 		}
...
+		return new JvmLocal(i, name, type, desc.toVarnode());
 	...
 	/**
@@ -730,7 +943,7 @@ private List<JvmLocal> genFreeLocals(String name, List<SimpleJitType> types,
...
+			VarDesc d = new VarDesc(desc.spaceId, offset, t.size(), t, language);
 			...
 			offset += t.size();
 			i++;
@@ -852,6 +1065,9 @@ private VarHandler createHandler(JitVal v) {
...
@@ -883,7 +1099,7 @@ private void allocate() {
 				.stream()
...
index 858ed53eb9b..44f0fae0946 100644
...
index 8dc4d197744..e83ac011181 100644
...
index 9d9d53aec90..07a62e851bf 100644
...
@@ -303,11 +302,11 @@ public void testInjectionError() throws Exception {
...
@@ -429,4 +428,60 @@ public void testInjectedIndirectBranch() throws Exception {
