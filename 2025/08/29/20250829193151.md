# Commit: 12ac4660a1009343dfaa069632ff33df02c01b4e
## Message: Merge remote-tracking branch 'origin/GP-5864_Dan_addEmulatorUtilities--SQUASHED'
## Diff:
```
...
index 4cad7ec97c9..63db71f21ec 100644
...
@@ -124,7 +124,7 @@ public T getAfter(long snap, Address address) {
...
index 73c9d754b2b..fad5b6b8018 100644
...
@@ -287,7 +287,7 @@ protected Iterator<DR> iterator(NR node, Q query) {
 			}
 			nodes.add(n);
 		}
...
index 198afe82ee9..ccc80955140 100644
...
@@ -374,4 +374,175 @@ default long quantizeOffset(AddressSpace space, long offset) {
 	 * dark.
 	 */
 	void clear();
+
