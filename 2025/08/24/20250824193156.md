# Commit: ce0c7b922975012b0e29d2822cba107b5b41094d
## Message: GP-5720 - Drop Down Modes - Added modes to drop-down text fields to control how matches are found
## Diff:
```
...
index 997db3fa948..36b3664d048 100644
...
@@ -783,7 +783,7 @@ protected void waitForAnimation(FGController controller) {
...
index 671de541fcb..4102c73038b 100644
...
+		setNestedLayout();
 	...
 	@Override
@@ -447,7 +451,7 @@ private GenericHeader getHeader() {
 		return dc.getHeader();
 	}
...
@@ -459,7 +463,7 @@ private void createCallout(JComponent parentComponent, CalloutComponentInfo call
...
@@ -467,22 +471,23 @@ private void createGroupButtonCallout(FGVertex v) {
...
@@ -780,28 +785,6 @@ private JComponent getComponent(final FGVertex vertex) {
...
@@ -869,6 +853,13 @@ private void setLayout() {
...
+		// that behavior.
 ...
 //==================================================================================================
@@ -898,28 +889,4 @@ protected File getHelpTopic() {
 			return helpTopicDir;
 		}
 	}
-
