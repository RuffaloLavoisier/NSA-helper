# Commit: bdf3c1d2f6c0740a07d0a368dc3f099b7f571ca3
## Message: GP-5885 - Updated the Next Instruction action to jump to the the function entry when in the function header
## Diff:
```
