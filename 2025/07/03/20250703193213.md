# Commit: 97d2a510388b73476a28c899466bd287615d4259
...
index 1381baffd03..d1fc4fe923d 100644
...
@@ -85,6 +86,7 @@ private void createActions() {
 				.keyBinding("ctrl A")
...
@@ -105,6 +107,7 @@ private void createActions() {
...
+				.enabledWhen(this::hasCodeViewer)
 				...
 				.buildAndInstall(tool);
@@ -116,6 +119,7 @@ private void createActions() {
...
+				.enabledWhen(this::hasCodeViewer)
 				...
 				.buildAndInstall(tool);
@@ -125,6 +129,7 @@ private void createActions() {
 				.menuGroup("SelectUtils")
 				.helpLocation(new HelpLocation(HelpTopics.CODE_BROWSER, "Selection_Tables"))
 				.withContext(ListingActionContext.class, true)
+				.enabledWhen(this::hasCodeViewer)
...
@@ -193,12 +198,22 @@ private void createTable(CodeViewerProvider componentProvider) {
