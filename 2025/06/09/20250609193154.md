# Commit: a1f777a1ddfe408095af607c591ae3625c5cfa7d
...
index 4004bcf5ae0..26eb297a0cc 100644
...
@@ -1367,7 +1367,7 @@ <H3><A name="DynamicDataType"></A>Dynamic Data Type</H3>
     </BLOCKQUOTE>
           </BLOCKQUOTE>
...
index 80c976c5f54..8ec06ad0efd 100644
...
@@ -844,8 +844,15 @@ public boolean isCreateDataAllowed(ListingActionContext context) {
...
@@ -856,10 +863,6 @@ private void editField(ListingActionContext context) {
 		int[] path = location.getComponentPath();
