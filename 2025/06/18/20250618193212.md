# Commit: 7db176b2bd4c5f230e6a8102d4d1d0e5b4369afb
## Message: GP-3952 Updated the script categories to simplify and reduce the number of folders.
## Diff:
```
...
index 94e58a27145..cc8a94f8cb4 100644
...
+//@category
 ...
 //@menupath 
 //@toolbar 
@@ -81,8 +81,12 @@ public void run() throws Exception {
...
@@ -155,7 +159,7 @@ private static boolean isToolchainVersionAfterV5(RichHeader rich) {
...
index 2f69d924481..a9178654476 100644
...
@@ -100,8 +101,9 @@ public void run() throws Exception {
...
index e1c251fd142..4470476c573 100644
...
+//@category Apple.Mac OS X
 ...
 import ghidra.app.script.GhidraScript;
 import ghidra.program.model.address.Address;
@@ -38,19 +37,19 @@ public void run() throws Exception {
...
@@ -59,49 +58,53 @@ private void loopOverInstructionsInFunction(Function function) {
...
@@ -112,43 +115,43 @@ private void loopOverInstructionsInFunction(Function function) {
...
index e83c6413d9f..2a8110b0c10 100644
