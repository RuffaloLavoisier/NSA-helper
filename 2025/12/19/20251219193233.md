# Commit: 40e0af6ee63201c42762cab6e7cba245041a2a5a
...
index 238e0cad671..8a81cf73a73 100644
...
@@ -696,9 +696,16 @@ protected BusyEmu doEmulateFromCached(CacheKey key, TaskMonitor monitor)
...
@@ -707,7 +714,7 @@ protected BusyEmu doEmulateFromCached(CacheKey key, TaskMonitor monitor)
...
+			try (BusyEmu be = new BusyEmu(cachePrefix.getValue())) {
 				...
 				emu.clearAllInjects();
@@ -722,18 +729,28 @@ protected BusyEmu doEmulateFromCached(CacheKey key, TaskMonitor monitor)
 				return be.dup();
 			}
 		}
+
...
@@ -762,6 +779,7 @@ protected TraceSnapshot writeToScratch(CacheKey key, CachedEmulator ce) {
