# Commit: 8d49a6ffaad3336a93c992706ece493a9c55b375
...
index 0ac74b4ddd0..b19717fc8fa 100644
...
+	private CalloutRequest callout;
 	...
 	public DockingHelpBroker(HelpSet hs) {
 		super(hs);
@@ -128,7 +117,7 @@ protected void installActions(JHelp help) {
...
@@ -158,254 +147,15 @@ protected void reloadHelpPage(URL url, boolean preserveLocation) {
...
@@ -415,75 +165,4 @@ public void idChanged(HelpModelEvent e) {
 		}
 	}
...
index abd7baa20c1..2241ae2b8b2 100644
...
@@ -815,7 +815,12 @@ else if (helpObj instanceof JButton) {
 			}
 		}
 		else {
...
diff --git a/Ghidra/Framework/Docking/src/main/java/docking/help/ToggleNavigationAid.java b/Ghidra/Framework/Docking/src/main/java/docking/help/NavigationAidToggleAction.java
similarity index 96%
rename from Ghidra/Framework/Docking/src/main/java/docking/help/ToggleNavigationAid.java
rename to Ghidra/Framework/Docking/src/main/java/docking/help/NavigationAidToggleAction.java
index 8bd568c358c..f8d226d17d1 100644
--- a/Ghidra/Framework/Docking/src/main/java/docking/help/ToggleNavigationAid.java
+++ b/Ghidra/Framework/Docking/src/main/java/docking/help/NavigationAidToggleAction.java
@@ -4,9 +4,9 @@
  * Licensed under the Apache License, Version 2.0 (the "License");
  * you may not use this file except in compliance with the License.
  * You may obtain a copy of the License at
