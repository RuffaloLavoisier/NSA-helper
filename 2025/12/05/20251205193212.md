# Commit: 5d6de5545c343239163c4dd2071561931502045f
...
index 24bdaed3c82..670e372c29e 100644
...
@@ -60,7 +60,7 @@
 ...
 <tr>
  <td></td>
- <td><link linkend="cpui_userdefined">USERDEFINED</link></td>
...
@@ -3388,9 +3388,9 @@ either the operator is just carried through as a black-box or it serves as a plu
...
-<sect2 id="cpui_userdefined"><title>USERDEFINED</title>
+<sect2 id="cpui_callother"><title>CALLOTHER</title>
 <informalexample>
-<table xml:id="userdefined.htmltable" frame="above" width="80%" rules="groups">
+<table xml:id="callother.htmltable" frame="above" width="80%" rules="groups">
 <col width="23%"/>
 <col width="15%"/>
 <col width="61%"/>
@@ -3443,14 +3443,14 @@ This is a placeholder for (a family of) user-definable p-code
...
-one or more <emphasis role="bold">USERDEFINED</emphasis> instructions
...
-the <emphasis role="bold">USERDEFINED</emphasis> instruction can take
...
@@ -4355,7 +4355,7 @@ The following table lists the basic forms of a semantic statement.
   </td>
 </tr>
 <tr>
-  <td><code><emphasis>USER_DEFINED</emphasis></code></td>
...
index 485d45f8280..ff2043bffd2 100644
...
index bbcc9f65160..f4e25e24c36 100644
...
index b21fc5f37dd..759695d67a9 100644
