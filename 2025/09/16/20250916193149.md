# Commit: ad35a7e956cc0d01720cf3f3b6e1674f7fb0a201
## Message: GP-5900: PeLoader now creates thunks in EXTERNAL block for forwarded exported functions
## Diff:
```
...
index a0883c05fdf..2ff5eb3a05d 100644
...
@@ -534,13 +534,26 @@ private void processExports(OptionalHeader optionalHeader, Program program, Task
 			return;
 		}
...
+
 		for (ExportInfo export : exports) {
 			if (monitor.isCancelled()) {
 				return;
@@ -548,65 +561,51 @@ private void processExports(OptionalHeader optionalHeader, Program program, Task
