# Commit: 8be2ef38569485a23804e30cd77935008adf2d09
## Message: GP-0: Formatting CONTRIBUTING.md
## Diff:
```
diff --git a/CONTRIBUTING.md b/CONTRIBUTING.md
index 4c7c524f9a9..cafeb62e7c1 100644
--- a/CONTRIBUTING.md
+++ b/CONTRIBUTING.md
@@ -30,97 +30,98 @@ Patches should be submitted in the form of Pull Requests to the Ghidra
