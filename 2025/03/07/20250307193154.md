# Commit: 92258b5b1b54125d569d4b107168f178f5dd8957
## Message: Merge remote-tracking branch 'origin/GP-2040_Dan_cleanAsyncUtils--SQUASHED'
## Diff:
```
...
index 60179b73b6f..7d7163ae0cb 100644
...
@@ -1058,9 +1060,11 @@ protected TraceObject getProcessForSpace(AddressSpace space) {
...
@@ -1085,40 +1089,50 @@ public CompletableFuture<Void> readMemoryAsync(AddressSetView set, TaskMonitor m
 		}
