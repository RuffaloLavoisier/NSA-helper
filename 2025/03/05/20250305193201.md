# Commit: 789a9fa4b7d2560bb1326848143e4c775a8f01d0
## Message: GP-5379: Require snap parameter in object getters/setters. Lots of fallout.
## Diff:
```
...
index 8ffa1025715..5953832dda6 100644
...
@@ -783,13 +784,12 @@ public void clearProperties(Address startAddr, Address endAddr, TaskMonitor moni
...
+			r -> new DBTraceProgramViewFragment(this, r, entry.snap));
 	...
 	@Override
@@ -802,13 +802,12 @@ public ProgramModule getModule(String treeName, String name) {
...
index 6f5a197dc5d..ad46e6f9b23 100644
...
index e77b345bcaf..4b33dd95dce 100644
