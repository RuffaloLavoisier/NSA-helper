# Commit: 86d5b1b7f4610548fdff0977b87ab93a42fa923a
## Message: Merge branch 'GP-5975_emteere_RISCV_Upgrade' into Ghidra_12.0
## Diff:
```
...
index 2d31c9333e2..2ccf428c5c0 100644
...
@@ -693,7 +693,7 @@ public boolean applyTo(Program obj, TaskMonitor monitor) {
...
index 31b9a991dec..1b641080bb9 100644
...
@@ -2065,8 +2066,10 @@ private void setLanguage(LanguageTranslator translator, CompilerSpecID newCompil
...
@@ -2138,6 +2141,9 @@ else if (!forceRedisassembly && language.getVersion() == languageVersion &&
