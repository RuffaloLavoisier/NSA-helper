# Commit: 3e89269102c5f77f9d28d4a82d0ceb3f63ed1f34
## Message: Merge remote-tracking branch
'origin/GP-6108_dragonmacher_PR-8609_ldm0_ldm_rust_mangler'
(Closes #8609)
## Diff:
```
diff --git a/Ghidra/Features/Base/certification.manifest b/Ghidra/Features/Base/certification.manifest
index 646decbb0d3..c4ee0a4d460 100644
--- a/Ghidra/Features/Base/certification.manifest
+++ b/Ghidra/Features/Base/certification.manifest
@@ -1086,6 +1086,7 @@ src/test.slow/resources/dirlist.txt||GHIDRA||reviewed||END|
...
index 946d8eb4a81..a0b323399f0 100644
...
@@ -42,24 +42,45 @@ else if (symbol.startsWith("__ZN")) {
 		}
...
index 47a20d0fd4e..c1db925dff4 100644
...
index b401dc42028..ca40f1b8ed1 100644
...
@@ -36,7 +35,7 @@ public class RustDemanglerLegacyTest {
...
@@ -62,4 +61,31 @@ public void demangle() {
 			}
 		}
 	}
+
...
diff --git a/Ghidra/Features/Base/src/test/java/ghidra/app/plugin/core/analysis/rust/demangler/RustDemanglerV0Test.java b/Ghidra/Features/Base/src/test/java/ghidra/app/plugin/core/analysis/rust/demangler/RustDemanglerV0Test.java
new file mode 100644
index 00000000000..16eadae7830
--- /dev/null
