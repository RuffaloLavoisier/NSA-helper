# Commit: 0d52943d1f7a521ba394fdfabbca22b3fd04321d
## Message: GP-6132: Fixed a bug in the the PyGhidra headless analyzer that resulted in the wrong exception being thrown when a script tries to import a module that isn't found
## Diff:
```
