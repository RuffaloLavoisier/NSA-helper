# Commit: 00f6e14cb531dfa296b8adbc29e3a9af9478f203
## Message: Merge remote-tracking branch 'origin/GP-6316_SleighUnique256' into patch
## Diff:
```
...
index 66f81e6ecd4..3b9a1342b41 100644
...
@@ -3894,13 +3880,12 @@ static void findSlaSpecs(vector<string> &res, const string &dir, const string &s
...
@@ -3912,7 +3897,6 @@ void SleighCompile::setAllOptions(const map<string,string> &defines, bool unnece
...
@@ -3947,7 +3931,6 @@ int main(int argc,char **argv)
...
-    cerr << "   -o              print warnings for temporaries which are too large" << endl;
     ...
     exit(2);
@@ -3962,7 +3945,6 @@ int main(int argc,char **argv)
...
@@ -3996,8 +3978,6 @@ int main(int argc,char **argv)
...
@@ -4033,8 +4013,7 @@ int main(int argc,char **argv)
...
@@ -4070,8 +4049,7 @@ int main(int argc,char **argv)
...
index d59f9829ebc..a193c7dbdb9 100644
...
index e1ee52bef44..9b63f8172b8 100644
...
@@ -545,13 +545,6 @@ private void checkConsistency() {
...
@@ -787,17 +780,6 @@ public void setEnforceLocalKeyWord(boolean val) {
...
@@ -1805,8 +1787,7 @@ public int printAssembly(PrintStream s, int size, Address baseaddr) {
...
@@ -1818,7 +1799,6 @@ public void setAllOptions(Map<String, String> preprocs, boolean unnecessaryPcode
 		setDeadTempWarning(deadTempWarning);
