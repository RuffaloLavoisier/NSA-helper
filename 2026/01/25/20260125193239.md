# Commit: fe374dd5b873ce4a8755ee0d6f714f10e97ebe6f
## Message: Merge remote-tracking branch 'origin/GP-6323-dragonmacher-program-tabs-focus--SQUASHED'
## Diff:
```
...
index b3d0000ceee..f282a99c094 100644
...
@@ -173,15 +172,15 @@ public ForListingTrackingTrait() {
 		}
...
+			trackingSpecChangeListeners.invoke().locationTrackingSpecChanged(lts);
 		...
 		@Override
@@ -348,6 +347,8 @@ protected boolean pasteByteString(String string) {
...
@@ -379,6 +380,9 @@ public DebuggerListingProvider(DebuggerListingPlugin plugin, FormatManager forma
...
+			dwm.addContextListener(contextListener);
 			...
 			traceTabs = null;
@@ -1049,4 +1053,44 @@ public AddressableByteSource getByteSource() {
 		}
