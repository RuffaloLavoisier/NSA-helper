# Commit: 293444d39616746a8c23231c07037c1be41e075a
...
index 7c9c4dc53a8..b13dce45e49 100644
...
@@ -761,6 +761,9 @@ public <B, U> void dataWritten(PcodeThread<Object> thread,
 				value)) {
 				return;
 			}
+			if (length == 0) {
...
index 55adbeaf232..07de6a410d0 100644
...
@@ -55,6 +56,74 @@ PcodeEmulator createEmulator(TracePlatform platform, Writer writer) {
