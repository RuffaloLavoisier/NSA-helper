# Commit: f8eada2b7ceb2bbf261c88c16fd9c9288ccfd21a
## Message: Merge remote-tracking branch 'origin/GP-1-dragonmacher-tab-icon-fix'
## Diff:
```
...
index 435e0cf95e0..2eb1c941f0c 100644
...
@@ -323,10 +323,11 @@ private int addComponentsToTabbedPane(List<ComponentPlaceholder> activeComponent
...
+			tabRenderer.setIcon(icon);
 			...
 			if (placeholder == top) {
 				activeIndex = i;
@@ -575,11 +576,14 @@ void titleChanged(ComponentPlaceholder placeholder) {
 		}
...
index 69e1a819a08..bd7cf212c5d 100644
