# Commit: 4d7fa43eafe8c16ae3f95433175776cafdca837c
## Message: Merge remote-tracking branch 'origin/GP-6414-dragonmacher-annotations-fix-auto-comments--SQUASHED' into patch
## Diff:
```
...
index 23add48ab57..d14cf1f8511 100644
...
@@ -866,6 +866,18 @@ else if (encoding == StandardCharsets.UTF_16BE || encoding == StandardCharsets.U
 		}
 	}
