# Commit: f2508b2765a89e0f832cf28c10eaf41db52d3e0b
## Message: 1) Extracted word diffing code to be reusable 2) Fixed table column ordering bug for columns added after the model is created 3) Fixed potential exception when processing highlights before being realized 4) Search result highlight fixes to restore highlights when the search results are disposed 5) Fixed the Function Graph screenshots blocking issue
## Diff:
```
