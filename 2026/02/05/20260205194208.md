# Commit: eb2d7fcc80dae8f23a0a8984dbcf893edc8e8554
## Message: GP-6374: main logic
## Diff:
```
...
index ba720d81700..812c2f725c8 100644
...
@@ -1529,6 +1535,11 @@ def put_single_exception(obj: TraceObject, objpath: str,
...
@@ -1543,6 +1554,8 @@ def put_single_exception(obj: TraceObject, objpath: str,
