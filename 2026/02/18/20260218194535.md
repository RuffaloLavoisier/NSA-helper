# Commit: be8ce50487898145afbf9ac1501f5e8c2d6b1fad
## Message: Fixed rendering and sorting of Find results in tables
## Diff:
```
...
index 6850f65f36c..f397a18fa59 100644
...
@@ -243,14 +243,14 @@ private DecompilerSearchLocation findNext(Function<String, SearchMatch> matcher,
...
+	private SearchLocationContext createContext(String line, int lineNumber, SearchMatch match) {
 		...
 		int end = match.end;
@@ -260,6 +260,7 @@ private SearchLocationContext createContext(String line, SearchMatch match) {
