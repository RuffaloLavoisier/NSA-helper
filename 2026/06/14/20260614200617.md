# Commit: c6e33b89b48993cd81798219d6bce6626e63477a
## Message: GP-6721: Improve the Dynamic GoTo dialog
## Diff:
```
...
index d4e90cbecb0..9d5fd6ed16a 100644
...
@@ -94,6 +95,23 @@ interface LocationTrackingSpecChangeListener {
 	 */
...
index 979763eb5ea..e169477610f 100644
...
@@ -121,6 +128,9 @@ public void actionPerformed(ActionContext context) {
...
@@ -352,6 +362,16 @@ public boolean goTo(Address address, boolean centerOnScreen) {
...
+
 	 ...
 	 * {@inheritDoc}
 	 * 
@@ -452,6 +472,8 @@ public void readDataState(SaveState saveState) {
 	@Override
...
@@ -473,6 +495,8 @@ public void writeConfigState(SaveState saveState) {
 	@Override
...
index f787eadf33b..f94cf4aa78e 100644
...
@@ -161,6 +161,12 @@ protected GoToInput getDefaultInput() {
...
@@ -503,7 +509,7 @@ void writeConfigState(SaveState saveState) {
 	}
