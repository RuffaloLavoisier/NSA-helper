# Commit: 7789fd45d3f45c835b5c189f0f01037d13d350c1
## Message: GP-6717: Implement a safe pattern around Class.forName
## Diff:
```
...
index 826b8f12c86..6615aa2e351 100644
...
@@ -182,7 +182,7 @@ public static <T> List<Class<? extends T>> getClasses(Class<T> ancestorClass,
 
 			Class<?> c = loadedCache.get(info);
 			if (c == null) {
-				c = loadExtensionPoint(info.path(), info.name());
+				c = loadExtensionPoint(info.path(), ancestorClass, info.name());
 				if (c == null) {
...
@@ -626,11 +662,12 @@ private static void fireClassListChanged() {
...
@@ -640,7 +677,8 @@ private static void fireClassListChanged() {
...
+	private static <T> Class<? extends T> loadExtensionPoint(String path, Class<T> ancestorClass,
+			String className) {
 
 		if (getExtensionPointSuffix(className) == null) {
 			return null;
@@ -649,7 +687,7 @@ private static Class<?> loadExtensionPoint(String path, String className) {
 		ClassLoader classLoader = getClassLoader(path);
 
 		try {
-			Class<?> c = Class.forName(className, true, classLoader);
+			Class<? extends T> c = forNameSafe(className, ancestorClass, classLoader);
