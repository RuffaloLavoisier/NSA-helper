# Commit: b09562048e566ef2670057d3805b990a732e5b54
...
index 958e1193fab..c0dc379480e 100644
...
index fbc8c32eba0..72219456459 100644
...
@@ -144,7 +151,6 @@ private void initializeFilter(List<ResourceFile> filterFiles,
 		}
 	}
...
@@ -211,7 +217,6 @@ else if (clazz.getPackageName().startsWith("jdk.proxy") && Proxy.isProxyClass(cl
...
@@ -271,7 +276,7 @@ private void trackClassDeserialization(FilterInfo info) {
 		}
...
@@ -301,7 +306,7 @@ private void trackClassDeserialization(FilterInfo info) {
 					}
 				}
 				catch (IOException e) {
...
@@ -354,7 +359,7 @@ private Status serialReject(FilterInfo info, String reason) {
...
@@ -369,7 +374,7 @@ private String readSerialFilterFiles(List<ResourceFile> filterFiles) throws IOEx
...
+			log().debug("Including serial input filter: " + path);
 			...
 			try (InputStream in = filterFile.getInputStream()) {
 				try {
@@ -433,7 +438,7 @@ private boolean consumeSpecialValue(String line) {
...
+
 		if (REMOTE_INTERFACE.equals(name)) {
 			...
 			try {
@@ -477,7 +482,7 @@ private long parseLong(String name, String valueStr, long defaultMin) {
...
@@ -519,7 +524,7 @@ public static void configureServerSerialFilter(ResourceFile filterFile,
...
@@ -528,7 +533,7 @@ public static synchronized void configureClientSerialFilter()
...
index 0e3a2992923..9951d6ae28c 100644
...
+ *
  ...
  * distributed under the License is distributed on an "AS IS" BASIS,
  * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
@@ -256,21 +256,19 @@ public static PackedEncode buildEncoder(ResourceFile sleighFile) throws IOExcept
