# Commit: 7d24f573dbb9d77a85a0eff76b102443597d7b17
...
index 4097d73e43e..5bb322e1bfd 100644
...
@@ -147,34 +148,25 @@ public static LocationMemento getLocationMemento(SaveState saveState, Program[]
 			return null;
 		}
...
index 53b2db3974d..a516aee9296 100644
...
index 8c8debe80a9..529f64baaba 100644
...
+import ghidra.util.classfinder.ClassSearcher;
 ...
 import utilities.util.FileUtilities;
@@ -433,17 +434,16 @@ private Date parseDate(String dateString) {
 	}
...
index 23d25f7554c..9cf7bb677cd 100644
...
@@ -274,6 +274,42 @@ public static <T> List<T> getInstances(Class<T> c, ClassFilter filter) {
...
@@ -631,11 +667,11 @@ private static void fireClassListChanged() {
...
index 75edc6f2ec9..35bb3c6a8c6 100644
...
index f6f155ca12b..3f35cafe5c4 100644
...
@@ -33,28 +34,21 @@ public WrappedCustomOption() {
...
index b995f92be78..70769da083b 100644
...
@@ -135,8 +135,8 @@ public void restoreFromXml(Element root) {
...
@@ -182,8 +182,7 @@ public Element saveToXml() {
...
index a696a6394ab..3576bad85dd 100644
...
@@ -1492,18 +1493,10 @@ private void initParallelHelper() {
 			return;
 		}
 		try {
...
index ccbacf5583b..371f9c7acd2 100644
...
+import ghidra.util.classfinder.ClassSearcher;
 ...
 import ghidra.util.exception.*;
 import ghidra.util.task.TaskMonitor;
@@ -2491,7 +2492,8 @@ private boolean isSourceSettable(DataType dataType) {
...
@@ -2807,9 +2809,10 @@ record = builtinAdapter.getRecord(dataTypeID);
...
@@ -2818,15 +2821,15 @@ record = builtinAdapter.getRecord(dataTypeID);
 						throw e;
 					}
 					try {
...
@@ -4541,7 +4544,7 @@ private void cacheResolvedDataType(DataType dt, DataType resolvedDt) {
...
@@ -4554,7 +4557,7 @@ private void cacheResolvedDataType(DataType dt, DataType resolvedDt) {
...
index 782a6185a91..f14fb987e48 100644
...
+import ghidra.util.classfinder.ClassSearcher;
 ...
 import ghidra.util.exception.*;
 import ghidra.util.task.TaskMonitor;
@@ -133,9 +134,10 @@ public ObjectPropertyMapDB(DBHandle dbHandle, OpenMode openMode, ErrorHandler er
 	 */
 	@SuppressWarnings("unchecked")
...
+				ObjectPropertyMapDB.class.getClassLoader());
 			...
 			// Check the classNameMap.
@@ -143,10 +145,10 @@ public static Class<? extends Saveable> getSaveableClassForName(String classPath
...
@@ -159,7 +161,7 @@ else if (!Saveable.class.isAssignableFrom(c)) {
...
index 5d221824868..dc42ebde3b6 100644
...
@@ -278,10 +279,10 @@ public static ProgramLocation getLocation(Program program, SaveState saveState)
 			return null;
 		}
...
@@ -290,13 +291,7 @@ public static ProgramLocation getLocation(Program program, SaveState saveState)
 				return null;
 			}
...
+			ProgramLocation loc = locationClass.getConstructor().newInstance();
 			...
 			if (loc.getAddress() != null) {
 				return loc;
@@ -305,6 +300,8 @@ public static ProgramLocation getLocation(Program program, SaveState saveState)
 		}
 		catch (ClassNotFoundException e) {
 			// this can happen for locations created by plugins that are no longer installed
