# Commit: eaf8367ba142430b84ad083a0872d1ec95cda0a8
## Message: Fix debugger module indexing startup hang
## Diff:
```
...
index ea420ea1d87..d1117f50483 100644
...
@@ -177,29 +184,103 @@ public Collection<IndexEntry> getByName(String name) {
...
@@ -237,28 +318,32 @@ protected void addToIndex(DomainFile file, Map<String, String> metadata) {
 		}
...
@@ -396,13 +481,15 @@ public DomainFile getBestMatch(TraceModule module, long snap, Program currentPro
