# Commit: 6963e13258a5bc0863c49f5e5022eb293e49c1cc
...
index 28ead6ffa30..6910983bded 100644
...
@@ -992,9 +992,7 @@ private void processRelocationTableEntries(ElfRelocationTable relocationTable,
...
@@ -2115,10 +2113,10 @@ else if (!isPrimary && (elfSymbol.isGlobal() || elfSymbol.isWeak())) {
...
@@ -2155,27 +2153,6 @@ else if (!isPrimary && (elfSymbol.isGlobal() || elfSymbol.isWeak())) {
 		}
 	}
