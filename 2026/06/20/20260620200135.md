# Commit: 2cb29c1c508045f306b46158a988c3a21898c3cd
## Message: GP-6904: post-review
GP-6904: a little documentation
GP-6904: bug fix
GP-6904: bug fix
GP-6904: ok on lldb, dbgeng
GP-6904: full? lldb, start on dbgeng
GP-6904: clean triple
GP-6904: cleaner, still working
GP-6904: working test after rebase
## Diff:
```
...
index c9adf6cd3ec..921e8d9f306 100644
...
@@ -85,9 +85,6 @@ private void valueCreated(TraceObjectValue value) {
...
-			}
 			...
 			if (frame == null) {
 				return;
@@ -107,9 +104,6 @@ private void valueLifespanChanged(TraceObjectValue value, Lifespan oldLife,
 			if (!value.getEntryKey().equals(TraceStackFrame.KEY_PC)) {
 				return;
 			}
-			if (!value.getEntryKey().equals(TraceStackFrame.KEY_SP)) {
...
index d9215fcb91c..b641dd1a8dd 100644
...
@@ -819,12 +819,23 @@ public UnwoundFrame<WatchValue> getGlobalsFakeFrame() {
...
index 3a97275b521..cd803448bf0 100644
...
@@ -195,26 +195,19 @@ private AnalysisUnwoundFrame<WatchValue> unwindStack(DebuggerCoordinates coordin
 				continue;
 			}
...
@@ -243,7 +236,7 @@ private SavedRegisterMap updateMap(AnalysisUnwoundFrame<WatchValue> frame,
 	}
...
@@ -284,20 +277,30 @@ private Address pcOrSp(AnalysisUnwoundFrame<WatchValue> frame,
