# Commit: 6950180a66dcb698c29f99b06188b95158a4a85b
...
index 14d2d9067e1..aeba8d09418 100644
...
@@ -101,13 +100,13 @@ public DataTypeManager getDataTypeManager(String ns) {
 			try {
 				DataTypeManager dtm;
 				if (ns.endsWith(".gdt")) {
...
+					dtm = openAsProgramFile(ns);
 				...
 				managers.put(ns, dtm);
 				return dtm;
@@ -119,43 +118,43 @@ else if (ns.endsWith(".gzf")) {
 		}
 	}
...
index 9e048b77adb..ce56c1943ae 100644
...
@@ -625,18 +625,9 @@ protected DebuggerCoordinates fixAndSetCurrent(DebuggerCoordinates newCurrent,
 		return newCurrent;
 	}
...
index f26b29f325e..8c27a40740c 100644
...
@@ -823,7 +823,7 @@ protected void createAndOpenProgramWithExePath(String path) throws IOException {
...
index 0f461cef411..6b7deedb5af 100644
...
index 73e392c6b4e..7892cb309bf 100644
...
@@ -151,7 +151,11 @@ public boolean export(File file, DomainObject domainObj, AddressSetView addrSet,
...
index 7516b1eceb8..d094fc331ec 100644
...
index 597ee50ff8f..1f53a1843d2 100644
...
index 5d1709ee29e..6dcd3bf5a01 100644
...
@@ -450,7 +450,7 @@ private static Set<DomainFile> doPostImportProcessing(PluginTool pluginTool,
...
@@ -460,7 +460,7 @@ private static Set<DomainFile> doPostImportProcessing(PluginTool pluginTool,
 			try {
...
@@ -477,16 +477,16 @@ private static Set<DomainFile> doPostImportProcessing(PluginTool pluginTool,
 						}
 					}
 				}
-				if (firstProgram) {
...
@@ -518,7 +518,7 @@ public static void addContentToProgram(PluginTool tool, Program program, FSRL fs
...
@@ -538,18 +538,9 @@ public static void addContentToProgram(PluginTool tool, Program program, FSRL fs
...
index 4c84198cdf9..0ec314489da 100644
...
index 264b91bd04e..d5063af2aba 100644
