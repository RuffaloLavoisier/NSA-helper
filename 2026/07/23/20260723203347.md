# Commit: 205a053b7252fbc08907d195bdb11659b60de2cf
...
index 375e30e37f2..22ef1b27bd9 100644
...
@@ -227,8 +228,9 @@ public AccessibleField getAccessibleField(int fieldNum) {
 	 */
...
@@ -236,8 +238,12 @@ public AccessibleField getAccessibleField(FieldLocation loc) {
 		if (layout == null) {
 			return null;
 		}
