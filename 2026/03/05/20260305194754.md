# Commit: 2a20c18d11b36d85d9ec1bce50306a13638551b3
## Message: GP-5895: Added a margin bar and new BreakpoinTimelinePlugin that displays breakpoint hits across the whole execution of a trace
## Diff:
```
