# Commit: 1fc22ba44f88bba26d728dd4d609d28c18633ba3
## Message: GP-2393 - Removed size restriction in Select Bytes dialog
## Diff:
```
...
index 5fe08eca945..ae1188b31f4 100644
...
@@ -253,8 +268,16 @@ Address getNewAddress(long offset, boolean isAddressableWordOffset)
 	 */
...
@@ -394,6 +417,7 @@ Address getNewAddress(long offset, boolean isAddressableWordOffset)
...
index bef7522f990..d34aef083bd 100644
...
@@ -363,17 +380,6 @@ Address getAddress(long offset, boolean isAddressableWordOffset)
...
-
 	 ...
 	 * displacement from the given address.
@@ -402,7 +408,7 @@ public Address subtractNoWrap(GenericAddress addr, BigInteger displacement)
...
@@ -414,7 +420,7 @@ public Address subtractNoWrap(GenericAddress addr, BigInteger displacement)
 	/** 
...
+	 * <p>
 	 ...
 	 * within its overlay address space is no longer supported.  Defined regions of an overlay space
 	 * may now be determined using {@link OverlayAddressSpace#getOverlayAddressSet()}.
@@ -506,22 +512,22 @@ public Address subtractNoWrap(GenericAddress addr, BigInteger displacement)
 	 * 
