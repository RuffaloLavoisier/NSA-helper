# Commit: 2f2b76910fd67ecbb1777b4e412b9ceb01713ca5
...
index a2fd22595af..003fc22bbc6 100644
...
@@ -143,7 +145,6 @@ public synchronized Repository createRepository(String currentUser, String name)
 		}
...
@@ -183,9 +184,11 @@ synchronized Repository getRepository(String name) {
...
@@ -429,23 +432,13 @@ public static String getRMIClient() {
 		return host;
 	}
...
@@ -453,11 +446,6 @@ public static void log(String repositoryName, String path, String msg, String us
 			buf.append(": ");
 		}
 		buf.append(msg);
-		if (userStr != null) {
...
index bca80e809ba..509a1f9f2a7 100644
...
@@ -231,7 +246,7 @@ private void validate() throws IOException {
 	/**
 	 * Read data from checkout file.
 	 * 
-	 * @throws IOException
+	 * @throws IOException if reading checkout data fails indicating storage file path
 	 */
 	@SuppressWarnings("unchecked")
 	private void readCheckoutsFile() throws IOException {
@@ -265,8 +280,8 @@ private void readCheckoutsFile() throws IOException {
...
+			throw new IOException("Invalid checkouts file: " + checkoutsFile, je);
 			...
 			istream.close();
@@ -278,7 +293,7 @@ private void readCheckoutsFile() throws IOException {
 	 * 
...
+	 * @throws JDOMException if checkout data parse fails
 	...
 	ItemCheckoutStatus parseCheckoutElement(Element coElement) throws JDOMException {
 		try {
@@ -302,7 +317,7 @@ ItemCheckoutStatus parseCheckoutElement(Element coElement) throws JDOMException
 	/**
...
@@ -341,14 +356,14 @@ private void writeCheckoutsFile() throws IOException {
...
index da978cca889..a47afdd4159 100644
--- a/build.gradle
+++ b/build.gradle
...
index bfe455092f4..c99348710a7 100644
--- a/gradle/javaTestProject.gradle
+++ b/gradle/javaTestProject.gradle
@@ -142,8 +142,10 @@ def initTestJVM(Task task, String rootDirName) {
...
@@ -165,7 +167,10 @@ def initTestJVM(Task task, String rootDirName) {
 			'-Duser.language=en',
...
@@ -175,19 +180,9 @@ def initTestJVM(Task task, String rootDirName) {
...
@@ -197,6 +192,17 @@ def initTestJVM(Task task, String rootDirName) {
