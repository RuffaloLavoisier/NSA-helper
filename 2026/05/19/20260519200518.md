# Commit: c7e16dd52774f75170f3bf6be41d3aea9f961dcf
## Message: GP-6799: Improve display of breakpiont 'kinds' in the UI. Also shorter db/protocol encoding.
## Diff:
```
...
index fc35765358a..22f812de990 100644
...
index 0eddc70ba95..da57d5498bd 100644
...
index ca7077b1ea8..50c3ab23217 100644
...
@@ -664,12 +665,8 @@ protected void installBreakpoints(Trace trace, long snap, PcodeMachine<?> emu) {
 					continue;
 				}
...
@@ -679,13 +676,13 @@ protected void installBreakpoints(Trace trace, long snap, PcodeMachine<?> emu) {
