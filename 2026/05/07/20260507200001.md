# Commit: dee3703ef605477516002962b19fa294393781db
...
index e597cca2dfa..55c4252dd5a 100644
...
index 5e3614963e9..de72136f9aa 100644
--- a/gradle/javaTestProject.gradle
+++ b/gradle/javaTestProject.gradle
@@ -175,8 +175,10 @@ def initTestJVM(Task task, String rootDirName) {
...
@@ -198,7 +200,10 @@ def initTestJVM(Task task, String rootDirName) {
 			'-Duser.language=en',
...
@@ -208,19 +213,9 @@ def initTestJVM(Task task, String rootDirName) {
...
@@ -230,6 +225,17 @@ def initTestJVM(Task task, String rootDirName) {
...
index 3e29398e5f3..03d7f468dad 100644
--- a/gradle/root/test.gradle
+++ b/gradle/root/test.gradle
@@ -311,8 +311,10 @@ def initTestJVM(Task task, String rootDirName) {
     task.minHeapSize xms
     task.maxHeapSize xmx
...
+		 	'-DupgradeProgramErrorMessage=' + upgradeProgramErrorMessage,
 			...
 			'-Dlog4j.configurationFile=' + logPropertiesUrl,
 			'-Dghidra.test.property.batch.mode=true',
@@ -333,8 +335,10 @@ def initTestJVM(Task task, String rootDirName) {
 			'-Duser.language=en',
 			'-Djdk.attach.allowAttachSelf',
 			'-XX:TieredStopAtLevel=1',
-			'-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=' + debugPort,
...
@@ -343,18 +347,19 @@ def initTestJVM(Task task, String rootDirName) {
 			'--add-opens=java.desktop/javax.swing=ALL-UNNAMED',			
 			'--add-opens=java.desktop/javax.swing.text=ALL-UNNAMED'
