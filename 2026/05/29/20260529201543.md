# Commit: b8c07ec79ba284fffd0c8b09836299ff767f692e
## Message: GP-6862 Improvements on Defaltor/Inflator stream use and other cleanup.
...
index ff7b6d04b0c..e171e70b662 100644
...
@@ -142,42 +132,24 @@ public ByteArrayOutputStream compress( byte [] decompressedBytes ) throws IOExce
...
index c8e532428c9..bee6a3ebe89 100644
...
@@ -56,18 +57,16 @@ private class ClientInputBlockStream implements InputBlockStream {
...
@@ -75,9 +74,6 @@ private class ClientInputBlockStream implements InputBlockStream {
 		public void close() throws IOException {
 			in.close();
 			socket.close();
-			if (inf != null) {
...
-			}
 		...
 		@Override
@@ -142,7 +138,7 @@ void serveBlockStream(Socket socket, BlockStream blockStream) throws IOException
...
@@ -159,36 +155,26 @@ void serveBlockStream(Socket socket, BlockStream blockStream) throws IOException
 		}
 	}
...
index c64834e48ad..9cc1a5b6e3c 100644
...
@@ -55,17 +55,14 @@ private class ClientOutputBlockStream implements OutputBlockStream {
...
@@ -84,9 +81,6 @@ public int getBlockSize() {
 		public void close() throws IOException {
 			out.close();
 			socket.close();
-			if (def != null) {
...
-			}
 		...
 		@Override
@@ -130,7 +124,7 @@ void serveBlockStream(Socket socket, BlockStream blockStream) throws IOException
...
@@ -155,43 +149,37 @@ void serveBlockStream(Socket socket, BlockStream blockStream) throws IOException
...
index a12b825af6a..1c24959c40a 100644
...
@@ -330,17 +330,19 @@ else if (data != null) {
 	 */
...
+					compressedData.length - compressedDataOffset);
 			...
 			if (!deflate.finished()) {
@@ -416,10 +418,11 @@ public int unsignedCompareTo(byte[] otherData, int offset, int len) {
 	 */
